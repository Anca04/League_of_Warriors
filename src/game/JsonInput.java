...
import game.entities.Credentials;
...
public class JsonInput {
    public static ArrayList<Account> deserializeAccounts() {
        String accountPath = "D:\\League_of_Warriors\\src\\game\\accounts.json";
        try {
...
//        System.out.println("Account Name: " + info.getName());
...
//        System.out.println("Games Completed: " + account.getGamesPlayed());
//        System.out.print("Favorite Games: ");
//        info.getFavouriteGames().forEach(game -> System.out.print(game + " "));
//        System.out.println();
//
//        System.out.println("Characters:");
//        for (Character character : account.getCharacters()) {
//            System.out.println("  Name: " + character.getCharacterName());
